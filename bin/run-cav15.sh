...
bin/run.sh $CONFIG src/benchmarks/svcomp/loops/ArrayTrueUnreachableLabelAdjusting.jpf 2>&1 | tee output/array-adjusting
echo
bin/run.sh $CONFIG src/benchmarks/svcomp/loops/ArrayTrueUnreachableLabelPruning.jpf 2>&1 | tee output/array-pruning
echo
bin/run.sh $CONFIG src/benchmarks/svcomp/loops/Eureka01TrueUnreachableLabelAdjusting.jpf 2>&1 | tee output/eureka-adjusting
echo
bin/run.sh $CONFIG src/benchmarks/svcomp/loops/Eureka01TrueUnreachableLabelPruning.jpf 2>&1 | tee output/eureka-pruning
echo
bin/run.sh $CONFIG src/benchmarks/svcomp/loops/TREX03TrueUnreachableLabelAdjusting.jpf 2>&1 | tee output/trex-adjusting
echo
bin/run.sh $CONFIG src/benchmarks/svcomp/loops/TREX03TrueUnreachableLabelPruning.jpf 2>&1 | tee output/trex-pruning
echo
bin/run.sh $CONFIG src/benchmarks/svcomp/loops/InvertStringTrueUnreachableLabelAdjusting.jpf 2>&1 | tee output/invert-string-adjusting
echo
...
echo
bin/run.sh $CONFIG src/benchmarks/svcomp/arrays/PasswordAdjusting.jpf 2>&1 | tee output/password-adjusting
echo
bin/run.sh $CONFIG src/benchmarks/svcomp/arrays/PasswordPruning.jpf 2>&1 | tee output/password-pruning
echo
bin/run.sh $CONFIG src/benchmarks/svcomp/arrays/ReverseArrayAdjusting.jpf 2>&1 | tee output/reverse-array-adjusting
echo
bin/run.sh $CONFIG src/benchmarks/svcomp/arrays/ReverseArrayPruning.jpf 2>&1 | tee output/reverse-array-pruning
echo
bin/run.sh $CONFIG src/benchmarks/svcomp/arrays/TwoIndicesAdjusting.jpf 2>&1 | tee output/two-indices-adjusting
echo
bin/run.sh $CONFIG src/benchmarks/svcomp/arrays/TwoIndicesPruning.jpf 2>&1 | tee output/two-indices-pruning
echo
bin/run.sh $CONFIG src/benchmarks/dataflow/DataFlowAnalysisAdjusting.jpf 2>&1 | tee output/dataflow-adjusting
echo
bin/run.sh $CONFIG src/benchmarks/dataflow/DataFlowAnalysisPruning.jpf 2>&1 | tee output/dataflow-pruning
echo
bin/run.sh $CONFIG src/benchmarks/cycling/CyclingRaceAdjusting.jpf 2>&1 | tee output/cycling-adjusting
echo
bin/run.sh $CONFIG src/benchmarks/cycling/CyclingRacePruning.jpf 2>&1 | tee output/cycling-pruning
echo
bin/run.sh $CONFIG src/benchmarks/image/ImageAdjusting.jpf 2>&1 | tee output/image-adjusting
echo
