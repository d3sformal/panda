...
echo
bin/run.sh $CONFIG src/benchmarks/alarmclock/SerialAlarmClockPruning.jpf 2>&1 | tee output/alarmclock-pruning
echo
bin/run.sh $CONFIG src/benchmarks/prodcons/SerialProducerConsumerPruning.jpf 2>&1 | tee output/prodcons-pruning
