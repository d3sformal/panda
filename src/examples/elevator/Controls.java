...
class Controls {
    ...
    public Vector<Integer> getUpPeople(int floor) {
        synchronized(floors[floor]) {   // DONE
            Vector<Integer> temp = floors[floor].upPeople;  // DONE
            floors[floor].upPeople = new Vector<Integer>(); // DONE
    ...
    public Vector<Integer> getDownPeople(int floor) {
        synchronized(floors[floor]) { // DONE
            Vector<Integer> temp = floors[floor].downPeople; // DONE
            floors[floor].downPeople = new Vector<Integer>();  // DONE
