...
public class Configuration {
	...
	public boolean isResultExclusive() {
		return theResultSemantics == EXCLUSIVE;
	}

	public boolean isResultConcurrent() {
		return theResultSemantics == CONCURRENT;
	}

	public boolean isResultNone() {
		return theResultSemantics == NONE;
	}

	public boolean isSynchronous() {
		return theExecuteSemantics == SYNCHRONOUS;
	}

	public boolean isAsynchronous() {
		return theExecuteSemantics == ASYNCHRONOUS;
	}

	public boolean isAll() {
		return theSubProblemSemantics == ALLVALUES;
	}

	public boolean isSome() {
		return theSubProblemSemantics == SOMEVALUES;
	}
}
