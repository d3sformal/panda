...
public class IntIntervalTest extends IntervalTest {
    public IntIntervalTest() {
        super(-3, 3);
    }
    ...
    public static void test1() {
        ...
        assertConjunction("x >= -3: true", "x <= 3: true");
    }
    ...
    public static void test5() {
        ...
        assertConjunction("x >= -2: true", "x <= 4: true");
    }
