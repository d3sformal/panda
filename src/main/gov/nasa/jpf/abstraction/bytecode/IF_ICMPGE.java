...
public class IF_ICMPGE extends gov.nasa.jpf.jvm.bytecode.IF_ICMPGE {
	...
	public Instruction execute(ThreadInfo ti) {
		...
		// abs_v2 >= abs_v1
		AbstractBoolean result = AbstractValue._ge(v1, abs_v1, v2, abs_v2);

		System.out.printf("IF_ICMPGE> Values: %d (%s), %d (%s)\n", v2, abs_v2, v1, abs_v1);
		...
		System.out.println("IF_ICMPGE> Result: " + conditionValue);
