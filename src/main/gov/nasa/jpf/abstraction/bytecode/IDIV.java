 ...
 */
public class IDIV extends gov.nasa.jpf.jvm.bytecode.IDIV implements AbstractBinaryOperator<Integer> {
    ...
    public Attribute getResult(Integer v1, Attribute attr1, Integer v2, Attribute attr2) {
         ...
         */
        return new Attribute(Abstraction._div(v1, abs_v1, v2, abs_v2), Divide.create(expr1, expr2));
    }
